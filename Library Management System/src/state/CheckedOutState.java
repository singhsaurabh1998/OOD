...
public class CheckedOutState implements ItemState {
    ...
    @Override
    public void placeHold(BookCopy bookCopy, Member member) {
        bookCopy.getItem().addObserver(member);
        System.out.println(member.getName() + " placed a hold on '" + bookCopy.getItem().getTitle() + "'");
    }
}
