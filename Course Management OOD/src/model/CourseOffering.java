...
public class CourseOffering {
    ...
    public void addObserver(CourseOfferingObserver observer) {
        observers.add(observer);
    }

    private void notifyObservers() {
        observers.forEach(o -> o.onSpotAvailable(this));
    }
    ...
    public Optional<Student> getNextFromWaitlist() {
        return Optional.ofNullable(waitlistedStudents.poll());
    }
    ...
    public static class Builder {
        ...
        public Builder at(TimeSlot timeSlot) {
